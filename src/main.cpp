...
void setup()
{
  ...
  tft.setTextColor(TFT_BLUE, TFT_BLACK);  // Adding a black background colour erases previous text automatically
  tft.drawString("Font 1  Alle Buchstabe",0,0,1);
  tft.setTextColor(TFT_RED, TFT_BLACK);
  tft.drawString("Font 2  Alle Buchsta",0,10,2);
  tft.setTextColor(TFT_PURPLE, TFT_BLACK);
  tft.drawString("Font 4  Alle",0,30,4);
  //tft.drawString("08:12",0,56,6);
  tft.setTextColor(TFT_GREEN, TFT_BLACK);
  tft.drawString("08:32",0,56,7);
  //tft.drawString("0:8",0,150,8);
...
void loop()
{
  ...
  sprintf(charbuff, "%02d:%02d" , Hour, Minute);
  tft.drawString(charbuff,0,120,6);
  }
  tft.setTextColor(TFT_YELLOW, TFT_BLACK);
  sprintf(charbuff, "%02d", Second);
  tft.drawString(charbuff,10,164,8);
